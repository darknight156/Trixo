        ...
        this.exec = async (message, args, prefix) => {
                ...
                return message.reply({
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`<:cross_trixo:1191728814204649552> | Command Usage<:arrow_flora:1175442088045854791> \`${prefix}play <name/songurl>\``)
                        .setFooter({
            ...
            if (type === "direct") {
                ...
                let em = this.client.utils
                    .premiumEmbed(message.guildId)
                    .setDescription(`<:music_trixo:1191723200204242976> | Choose the search engine you prefer to play Music/Search Songs from it`)
                .setFooter({
                                        text: `Requested By: ${message.author.tag}`,
                        iconURL: `${message.author.displayAvatarURL({ dynamic: true })}`
                                    })
