...
export default class Profile extends OrasCommand {
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
            ...
            mem = mem.data;
            let sikku = mem?.roles;
            if (user.id === "1130505804009721886")
                badges += `\n<:rOwner__flora:1175788457516351580> **[DarkNighT](https://discord.com/users/1130505804009721886)**`;
            if (user.id === "1126349436444999751")
                badges += `\n<:rOwner__flora:1175788457516351580> **[Xtressy](https://discord.com/users/1126349436444999751)**`;
            if (user.id === "259176352748404736")
                badges += `\n<:owner:1166375413778493501> **[Sumit](https://discord.com/users/259176352748404736)**`;
            if (user.id === "1188178871049265282")
                badges += `\n<:rOwner__flora:1175788457516351580> **[DarkNighT](https://discord.com/users/1188178871049265282)**`;
