                ...
                return message
                    ...
                    embeds: [
                        this.client.utils
                            ...
                            .setDescription(`**•** My prefix here <:arrow_flora:1175442088045854791> \`${prefix}\`\n**•** Try me with this command <:arrow_flora:1175442088045854791> \`${prefix}help\` or \`${prefix}setup\`\n**•** Do u like me? If yes then please Invite me and join the Support Server for support`)
                            .setFooter({
